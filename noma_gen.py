...
def generate_markdown_report(experiments_dir: str, output_dir: str) -> str:
    ...
    report_path = os.path.join(output_dir, "noma_research_report.md")
    agents = ["MATD3", "CENT_NOMA_TD3"]
...
if __name__ == '__main__':
    generate_comparison_plots('experiments', 'results')
    generate_markdown_report('experiments', 'experiments/reports')
    generate_pdf_report('experiments/reports/noma_research_report.md', 'experiments/reports/noma_research_report.pdf')
